...
You are tasked with upgrading a Java application from Java 17 to Java 21 using Amazon Corretto JDK. **You must strictly follow the instructions provided in the file [java21-upgrade-instructions.md](docs/ai-tasks/instructions/java-17-to-21-upgrade-instructions.md).**
